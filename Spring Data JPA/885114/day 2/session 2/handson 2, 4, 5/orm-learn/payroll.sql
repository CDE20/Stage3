...
insert into employee values(1, "ABCD", 24000.00, true, "1999-03-01", 1);
insert into employee values(2, "BCDE", 23000.00, true, "1999-02-03", 1);
insert into employee values(3, "CDEF", 25000.00, true, "1999-10-11", 3);
insert into employee values(4, "DEFG", 26000.00, true, "1999-05-07", 2);
